...
Object.assign(AuthSha256Prototype, {
  ...
  setUri: function setUri (uri) {
    ...
    if (typeof uriObj['user'] !== 'undefined' && uriObj['user']) {
      this.setUser(uriObj['user'])
    }
    if (typeof uriObj['pass'] !== 'undefined' && uriObj['pass']) {
      this.setPass(uriObj['pass'])
    }
    if (typeof uriObj['port'] !== 'undefined' && uriObj['port']) {
      this.setPort(uriObj['port'])
    }
  ...
  setPass: function setHost (pass) {
    this.pass = (typeof pass === 'undefined' || (!pass)) ? '' : pass
    return this
  },
  setUser: function name (user) {
    this.user = (typeof user === 'undefined' || (!user)) ? '' : user
    return this
  },
  setPort: function name (port) {
    this.port = (typeof port === 'undefined' || (!port)) ? '' : port
    return this
  },
